...
export default function TrendTradingBotUI() {
    ...
    return (
        <div className="">
            <div className=" text-black dark:text-white p-6 min-h-screen">
                <div className="max-w-4xl mx-auto space-y-6">
                    <h1 className="text-3xl font-bold text-center mb-8">Trend Trading Bot</h1>

                    {/* Trade Execution Panel */}
                    <div className=" bg-white dark:bg-boxdark p-6 rounded-lg shadow-md space-y-4">
                        <h2 className="text-xl font-semibold mb-4">Bot Configuration</h2>

                        <div>
                            <label htmlFor="crypto-select" className="block mb-2">Select Crypto</label>
                            <select
                                id="crypto-select"
                        ...
                        <div>
                            <label htmlFor="investment" className="block mb-2">Investment (USDT)</label>
                            <input
                                id="investment"
                                type="number"
                                value={investment}
                        ...
                        <div>
                            <h3 className="font-semibold mb-2">Grid Steps</h3>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md space-y-4">
                        ...
                        <div className="text-center">
                            <h3 className="text-lg font-medium">Current ROI</h3>
                            <p className={`text-3xl font-bold ${currentROI >= 0 ? 'text-green-500' : 'text-red-500'}`}>
                                ...
                                <table className="min-w-full bg-white dark:bg-gray-700 shadow-md rounded-lg overflow-hidden">
                                    <thead className="bg-gray-200 dark:bg-gray-600">
                                        <tr>
                                            ...
                                            <th className="py-2 px-4 text-left">Buy Price</th>
                                    ...
                                    <tbody>
                                        {tradeHistory.map((trade, index) => (
                                            <tr key={index} className="border-b dark:border-gray-600">
                                                ...
                                                <td className="py-2 px-4">${trade.buyPrice.toFixed(2)}</td>
                                                <td className="py-2 px-4">${trade.sellPrice.toFixed(2)}</td>
                                                <td className={`py-2 px-4 ${trade.profitPercentage >= 0 ? 'text-green-500' : 'text-red-500'}`}>
