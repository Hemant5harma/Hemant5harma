      ...
      {isTokenSelectorOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-lg max-h-[80vh] overflow-hidden rounded-2xl bg-[#FFFFFF] shadow-2xl dark:bg-gray-800 dark:shadow-none"
          ...
          >
            ...
            <div className="bg-gradient-to-r from-primary to-secondary p-6 text-white">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-purple-100 text-sm">{selectedNetwork.name}</p>
                </div>
                <button
                  onClick={() => setIsTokenSelectorOpen(false)}
            ...
            {/* Search */}
            <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-[#FAFBFC] dark:bg-gray-800 shadow-inner dark:shadow-none">
            ...
            {/* Token List */}
            <div className="max-h-96 overflow-y-auto p-2 bg-[#FAFBFC] dark:bg-gray-800 shadow-inner dark:shadow-none">
                  ...
                  {filteredTokens.map((token) => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full flex items-center justify-between p-4 rounded-xl bg-[#FAFBFC] hover:bg-[#FFFFFF] hover:shadow-sm transition-all duration-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:hover:shadow-none"
                      >
      ...
      {isSettingsOpen && (
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-primary to-secondary p-6 text-white">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-purple-100 text-sm">Configure your trading preferences</p>
                </div>
                <button
                  onClick={() => setIsSettingsOpen(false)}
                  className="rounded-full p-2 text-white/80 hover:bg-white/20 hover:text-white transition-colors"
            ...
            <div className="p-6 bg-[#FAFBFC] dark:bg-gray-800 shadow-inner dark:shadow-none">
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl bg-[#FAFBFC] text-gray-900 transition-all duration-200 focus:border-primary focus:bg-[#FFFFFF] focus:outline-none focus:ring-4 focus:ring-primary/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:border-primary"
                  placeholder="Custom %"
                  step="0.01"
                  min="0.01"
                  max="50"
              ...
              <button
                onClick={() => setIsSettingsOpen(false)}
                className="w-full py-4 bg-gradient-to-r from-primary to-secondary text-white font-semibold rounded-xl transition-all duration-200 hover:from-primary/90 hover:to-secondary/90 hover:shadow-lg dark:shadow-none"
              >
                Save Settings
              </button>
            </div>
        ...
        <div className="mx-auto max-w-2xl">
          ...
          >
            ...
            <h1 className="mb-4 text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-5xl">
              <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Swap</span>{" "}
              Tokens
            </h1>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="hidden sm:flex items-center space-x-2 rounded-xl bg-gradient-to-r from-primary to-secondary px-4 py-3 font-medium text-white shadow-lg transition-all duration-200 hover:from-primary/90 hover:to-secondary/90 hover:shadow-xl"
          ...
          >
            ...
            <div className="p-4 bg-[#FAFBFC] dark:bg-gray-800 shadow-inner dark:shadow-none">
              <div className="relative">
                <select
              ...
              <div className="mt-3 flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <div
                    className={`h-2 w-2 rounded-full ${balanceLoading ? "bg-yellow-500 animate-pulse" : "bg-green-500"}`}
                  />
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-sm text-blue-700 dark:text-blue-300">
                      ...
                      , but you've selected <span className="font-semibold">{selectedNetwork.name}</span>.
                    </p>
                    <button
          ...
          >
            <div className="p-6 sm:p-8 bg-[#FAFBFC] dark:bg-gray-800 shadow-inner dark:shadow-none">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center space-x-4 rounded-2xl bg-[#FAFBFC] p-4 shadow-inner dark:bg-gray-700 dark:shadow-none">
                  <input
                    ...
                    placeholder="0.0"
                    className="flex-1 bg-transparent text-2xl font-bold text-gray-900 outline-none placeholder-gray-400 dark:text-white dark:placeholder-gray-500"
                  />
                  <button
                  ...
                  >
                    {sellToken ? (
                      <>
                        <div className="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-bold text-sm shadow-lg">
              ...
              <div className="mb-6 flex justify-center">
                <button
                  onClick={swapTokens}
                  className="group rounded-2xl bg-gradient-to-r from-primary to-secondary p-4 text-white shadow-lg transition-all duration-200 hover:from-primary/90 hover:to-secondary/90 hover:shadow-xl hover:scale-110"
                >
              ...
              {quoteLoading && (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-semibold text-blue-700 dark:text-blue-300">Getting best price...</span>
                  </div>
                </motion.div>
              )}
              ...
              {quoteError && (
                ...
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-sm font-medium text-red-700 dark:text-red-300">{quoteError}</span>
                  </div>
                </motion.div>
              )}
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span
                          className={`font-semibold ${
                            Number.parseFloat(quote.price_impact) > 5 ? "text-red-500" : "text-green-500"
                          }`}
                        >
                          {quote.price_impact}%
                        </span>
              ...
              <button
                ...
                className={`group relative w-full overflow-hidden rounded-2xl p-1 shadow-xl transition-all duration-300 ${
                  ...
                  !quoteLoading &&
                  !(sellToken && buyToken && sellToken.address.toLowerCase() === buyToken.address.toLowerCase())
                    ? "bg-gradient-to-r from-primary to-secondary hover:shadow-2xl hover:scale-[1.02] active:scale-[0.98] dark:shadow-none"
                ...
                <div className="rounded-xl bg-gradient-to-r from-primary to-secondary px-8 py-4 text-center">
                  <div className="flex items-center justify-center space-x-3">
                    {loading ? (
                      ...
                      <span className="text-lg font-semibold text-gray-500 dark:text-gray-400">Select Tokens</span>
                    ) : sellToken && buyToken && sellToken.address.toLowerCase() === buyToken.address.toLowerCase() ? (
                      ...
                      <span className="text-lg font-semibold text-gray-500 dark:text-gray-400">Getting Quote...</span>
                    ) : !quote ? (
                      <span className="text-lg font-semibold text-gray-500 dark:text-gray-400">
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3 min-w-0 flex-1">
                              <div className="flex items-center space-x-2">
                                <div className="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-bold text-xs shadow-lg">
