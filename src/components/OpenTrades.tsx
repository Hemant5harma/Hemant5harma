    ...
    <div className="rounded-lg bg-white px-5 pt-6 pb-2.5 shadow-default dark:bg-boxdark sm:px-7.5 xl:pb-2.5">
      ...
      <div className="flex flex-col w-full overflow-auto">
        <div className="flex flex-row w-max rounded-sm bg-gray-2 dark:bg-meta-4">
          ...
          <div className="p-2 min-w-[120px]">
            <h5 className="text-sm font-medium xsm:text-sm">Date</h5>
          </div>
          <div className="p-2 min-w-[120px]">
            <h5 className="text-sm font-medium xsm:text-sm">Amount</h5>
          </div>
          <div className="p-2 min-w-[120px]">
            <h5 className="text-sm font-medium xsm:text-sm">Total Executed</h5>
          </div>
          ...
          <div className="p-2 min-w-[140px]">
            <h5 className="text-sm font-medium xsm:text-sm">Current Gain</h5>
          </div>
          <div className="p-2 min-w-[80px]">
            <h5 className="text-sm font-medium xsm:text-sm">View</h5>
          </div>
          <div className="p-2 min-w-[120px]">
            <h5 className="text-sm font-medium xsm:text-sm">Action</h5>
          </div>
        </div>
