...
const ConditionBuilder: React.FC<ConditionBuilderProps> = ({ 
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {selectedCondition.value === 'price_drop' && (
            <div>
              <label className="block text-xs font-medium mb-1">Price Drop Threshold (%)</label>
              <NumberInput
          ...
          {selectedCondition.value === 'rsi_oversold' && (
            <>
              <div>
                <label className="block text-xs font-medium mb-1">RSI Threshold</label>
                <NumberInput
          ...
          {selectedCondition.value === 'volume_spike' && (
            <>
              <div>
                <label className="block text-xs font-medium mb-1">Volume Multiplier</label>
                <NumberInput
          ...
          {selectedCondition.value === 'support_level' && (
            <>
              <div>
                <label className="block text-xs font-medium mb-1">Support Price (USDT)</label>
                <NumberInput
              ...
              <div>
                <label className="block text-xs font-medium mb-1">Tolerance (%)</label>
                <NumberInput
                  value={(params.tolerance || 0.02) * 100}
                  onChange={(value) => {
                    const numValue = typeof value === 'number' ? value : (typeof value === 'string' ? parseFloat(value) : 2);
          ...
          {selectedCondition.value === 'moving_average_cross' && (
            <>
              <div>
                <label className="block text-xs font-medium mb-1">Fast MA Period</label>
                <NumberInput
              ...
              <div>
                <label className="block text-xs font-medium mb-1">Slow MA Period</label>
                <NumberInput
  ...
  return (
    <div className={`bg-gray-50 dark:bg-gray-700 rounded-xl p-4 ${className}`}>
